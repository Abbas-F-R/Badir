...
public class GenericRepository<T, TId> : IGenericRepository<T, TId> where T : BaseEntity
{
        ...
        bool deleted = false)
    {
        ...
        query = include != null ? include(query) : query;
            query = query.OrderByDescending(model => model.Id);
    ...
    public async Task<T?> Add(T entity, int? userId = null)
    {
    ...
    public async Task<T?> Delete(TId id, int? userId = null)
    {
    ...
    public async Task<T?> SoftDelete(TId id, int? userId = null)
    {
        var result = await GetById(id);
        if (result == null) return null;
    ...
    public async Task<T?> Update(T entity, int? userId = null)
    {
    ...
    public async Task<List<TDto>> UpdateAll<TDto>(List<T> entities, int? userId = null)
    {
    ...
    public async Task<List<T>> UpdateAll(List<T> entities, int? userId = null)
    {
